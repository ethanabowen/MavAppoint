		    				...
		    				$(document).ready(function(){
		 		    		...
		 		    		<% int i = 0;
									for (i=0;i<schedules.size();i++){%> 
		 								{
		 									title:'<%=schedules.get(i).getName()+schedules.get(i).getUniqueId()%>',
									...
									if (appointments != null){
										for(i=1;i<appointments.size()+1;i++){ //start array at 1 to prevent 0 id -> appointment id's must be negative%> 
 											...
 											<%if(i != (appointments.size()-1)||appointments != null){%>,<%}%>
 										<%}
									}%>		 					 
		 					 			]<%}%>
		    					});
			...
			<div class="modal-content">
				...
				<div class="modal-body">
						<label for="starttime">Start Time:</label>
		 				...
		 				<input type="datepciker" class="form-control" name=opendate id="opendate">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
						<label for="StartTime">Start Time:</label>
		 				...
		 				<input type="text" class="form-control" name=Date id="startdate">
